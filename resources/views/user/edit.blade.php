                ...
                <div class="card-body">
                    <form method="post" action="{{ route('user.update', $user->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nama_lengkap" value="{{ $user->nama_lengkap }}" type="text" class="form-control @error('nama_lengkap') is-invalid @enderror" name="nama_lengkap" required autocomplete="nama_lengkap" autofocus>
                                @error('nama_lengkap')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="hp" type="text" value="{{ $user->hp }}" class="form-control @error('hp') is-invalid @enderror" name="hp" required autocomplete="hp">
                                @error('hp')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
